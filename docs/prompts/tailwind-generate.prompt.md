<!--做网站，先生成样式元数据，省去了设计师。再用提示词模板，把网站功能需求喂给比如Sonnet等AI或Firebase Studio，就会自动产生一套基本的网站代码 https://60mcp23013.yourware.so/?continueFlag=58d40bc0abe9c636409903e71be8c30b 链接-->
